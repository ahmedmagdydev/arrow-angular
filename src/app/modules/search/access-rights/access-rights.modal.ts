...
import {accessTableInfoLookup} from '../../../config/Lookups';
...
@Component({
  ...
  templateUrl: './access-rights.modal.html',
  styleUrls: ['./access-rights.modal.scss'],
...
export class AccessRightsModal implements OnInit{
	...
	nestedNodeMap = new Map<TodoItemNode, TodoItemFlatNode>();
	 ...
	 newItemName = '';
	   ...
	   constructor(private database: ChecklistDatabase, private util: UtilService) {
